...
const RegisterDeal = () => {
    ...
    const validate = () => {
        ...
        const requiredFields = [
            ...
            "customerName", "mailingCountry", "address", "mailingCity"
        ];
    ...
    return (
        ...
        >
            ...
            <Container maxWidth="md" sx={{ position: "relative", zIndex: 1 }}>
                ...
                >
                    <Typography variant="h4" fontWeight="bold" mb={4} align="center" sx={{ color: "#ffffff" }}>
                        Register New Deal
                    </Typography>
                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12} sm={6}>
                                <FormControl fullWidth>
                                    <InputLabel shrink sx={{ color: "#e8e8e8" }}>Partner Sales Rep</InputLabel>
                                    <Select
                            ...
                            <Grid item xs={12} sm={6}>
                                <FormControl fullWidth>
                                    <InputLabel shrink sx={{ color: "#e8e8e8" }}>Partner SE</InputLabel>
                                    <Select
                                        name="partnerSE"
